...
void card::printCard()const {
	...
	case 3: cout << "Червы" << " ";break; //Червы
	case 2: cout << "Бубны" << " ";break; //Бубны
	case 1: cout <<"Трефи" << " ";break; //Трефи
	case 0: cout << "Пики" << " ";break; //Пики
	}
}
...
public:
	...
	void distrib(players &p1, players &p2);	//Раздача карт
private:
...
public:
	...
	void enqueueMore(players& c); //Помещение в хвост карт со "стола" выйгрывшему игроку
private:
	card *tail;
};
