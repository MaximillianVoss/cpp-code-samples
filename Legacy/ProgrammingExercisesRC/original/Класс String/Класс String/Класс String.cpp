...
public:
	...
	int myStrcmp(const myString &str2)const;	//сравнение строк
...
int main() {
	myString str, str2("example");	//объявляем две строки
	str.myStrcat("string1").print();	//сцепление строк
	cout << str2.myStrlen() << endl;	//печать длины строки
	str.myStrstr(str, "r").print();	//поиск строки в строке
	str.myStrcpy(str2).print();	//копирование строки в строку
	cout << str.myStrcmp("example") << endl;	//печать результата сравнения
