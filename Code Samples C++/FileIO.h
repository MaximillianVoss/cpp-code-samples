...
#pragma region Запись
	...
	void Write(string fileName, vector<string> lines, bool addNewLine = false)
	{
	...
	void Write(string fileName, vector<vector<string>> matrix)
	{
		ofstream stream(&fileName[0]);
...
#pragma region Чтение
	...
	///< param name="fileName">имя файла</param>ы
